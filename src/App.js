...
import { 
  ...
  SportsTennis, SportsHockey, SportsCricket, SportsRugby, SportsVolleyball,
  Calendar, Star, TrendingDown, Award, Users2, Globe, Filter, ChevronRight,
...
function Navigation() {
  ...
  const sports = [
    ...
    { id: 'hockey', name: 'Hockey', icon: SportsHockey, color: 'from-blue-500 to-blue-600' },
    { id: 'cricket', name: 'Cricket', icon: SportsCricket, color: 'from-purple-500 to-purple-600' },
    { id: 'rugby', name: 'Rugby', icon: SportsRugby, color: 'from-red-500 to-red-600' }
  ];
...
function LiveMatchesPage() {
  ...
  return (
    <div className="space-y-8">
      <div className="text-center py-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">⚡ Live Matches</h1>
        <p className="text-gray-600">Real-time live matches from ESPN API across all sports</p>
      </div>
          ...
          {sports.map((sport) => {
            ...
            return (
              <button
                ...
                onClick={() => setSelectedSport(sport.id)}
                className={`px-4 py-2 rounded-lg transition-all duration-200 flex items-center space-x-2 ${
                  isSelected ? 'bg-white text-blue-600 shadow-md' : 'text-gray-600 hover:text-gray-900'
                }`}
              >
                <Icon className="w-4 h-4" />
                <span>{sport.name}</span>
...
function NewsPage() {
  ...
  return (
    <div className="space-y-8">
      <div className="text-center py-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">📰 Latest Sports News</h1>
        <p className="text-gray-600">Stay updated with breaking news, analysis, and insights from the sports world</p>
        <div className="mt-4">
          <button 
            onClick={fetchSportsNews}
            disabled={loading}
...
function StatisticsPage() {
  ...
  return (
    <div className="space-y-8">
      <div className="text-center py-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">📊 Sports Statistics</h1>
        <p className="text-gray-600">Comprehensive statistics and analytics across all sports</p>
      </div>
...
function AboutPage() {
  return (
    <div className="space-y-8">
      <div className="text-center py-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">ℹ️ About SportLive</h1>
        <p className="text-gray-600">Your comprehensive sports platform powered by real-time data</p>
      </div>
